...
| where properties.changeAttributes.changedBy == "useraccounthere" or properties.changeAttributes.changedBy contains "@emailaccount"
...
Send-automatedemail @emailParams
