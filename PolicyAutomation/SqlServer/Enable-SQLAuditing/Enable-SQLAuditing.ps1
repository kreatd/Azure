...
# Note: This takes upwards of a minute to complete execution locally.
...
#constants:
$remediationDeploymentName = 'EnableSqlAuditing'
...
if ($eventGridEvent) {
    ...
    try {
        ...
        Set-AzSqlServerAudit @paramsSetAzSqlServerAudit
    }
    catch {
        $paramsDatabaseRecord.exeception = $_
        Write-ToDatabase @paramsDatabaseRecord
