...
#constants:
$remediationDeploymentName = 'StorageAccountDisallowKeyAccess'

# mandatory configurations:
$disableAllowSharedKeyAccess = $False
...
if ($eventGridEvent) {
    ...
    try {
        $storageAccount.Properties.allowSharedKeyAccess = $disableAllowSharedKeyAccess
