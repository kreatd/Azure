...
#constants:
$remediationDeploymentName = 'StorageAccountDisallowPublicAccess'

# mandatory configurations:
$disableAllowBlobPublicAccess = $False
...
if ($eventGridEvent) {
    ...
    try {
        $storageAccount.Properties.allowBlobPublicAccess = $disableAllowBlobPublicAccess
