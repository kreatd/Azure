...
#! If the user has the config 'Allow public access from specific virtual networks and IP addresses' set
#! then we will break those existing connections.
#
# I assume we are going to use private endpoints, but wanted to point this out!
...
#constants:
$remediationDeploymentName = 'DisablePublicNetworkAccess'
